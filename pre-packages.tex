...
\usepackage[locale=DE,per-mode=symbol,range-units=repeat,separate-uncertainty=true]{siunitx} % A comprehensive (SI) units package https://www.ctan.org/pkg/siunitx
...
\usepackage[style=numeric, citestyle=numeric, backend=biber, date=short, sorting=none]{biblatex} % Sophisticated Bibliographies in LaTeX https://www.ctan.org/pkg/biblatex
...
\usepackage[ngerman]{cleveref} % Intelligent cross-referencing https://www.ctan.org/pkg/cleveref
